    ...
    return (
        <div className="hero bg-base-200 py-8">
            <div className="hero-content text-center">
                <div>
                    <h1 className="text-5xl font-bold text-gray-800">We Build</h1>
                    <h1 className="text-5xl font-bold text-purple-700">Productive Apps</h1>
                    <p className="py-6 text-[12px] text-gray-400">
                    ...
                    <div className='flex justify-center items-center gap-2'>
                        <NavLink to={'https://play.google.com/store/games?hl=en'} target='_blank' rel='noopener noreferrer' className="btn border-1 border-gray-300 py-1 px-2">
